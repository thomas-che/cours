...
x(a,b)  b   maximum entre les valeurs                                                                                                                                                                   
                                                                                                                                                                                                    
01.04_CM_expressions                                                                                                                                                                                
...
<       inferieur                   False   False   False                       
< = (atacher)       inferieur ou egal                   
>       superieur ; privilegier inferieur               
> = (atacher)       superieur ou egal ; privilegier inferieur ou egale              
. ==  (sans le point)       egal            
!=      difference      
...
\t      tab                                                                                         
\n      retour ligne                                                                                            
' xx '  ' xx '  chaine ; ne s en ocupe pas, recrache tel quel ; posible avec " xx " float('12'+'3') -> 123  colle juste les 2 chaine        
..\' xx \'..    ..'xx'..    mettre mot entre "crochet" dans une chaine, le proteger avec \'xx \' ; posible avec \" xx "\        
...
x_ 1 (sans espace)      variable x1 ; apres peut construire x2 avec x_ 2 … ; ou simplement juste x puis un chifre                                                                                           
x_xx        nomer variable  en_stock                                                                                        
        constante en majuscule  TVA                                                                                     
...
print(x+x)  2x  print [en] = imprimer ; affiche x   print(1+2)  -> 3                                                                                    
print("x")  x   affiche texte entre "xx"    print("test")   -> test                                                                                 
                                                                                                                                                                                                    
                                                                                                    
03.03_CM_bibliotheque                                                                                                   
                                                                                                    
from yy import xx       dans la biblioteque/module yy importe la fonction xx    voir C150                                                                                       
...
04.03_CM_iteration_algo                                                                                                 
                                                                                                    
for indice, x in enumerate(b)       b prend la valeur d indice 0 : z                                                                                            
break       arrete la boucle for                                                                                            
                                                                                                                                                                                                    
                                                                                                    
04.04_CM_listes_complements                                                                                                 
                                                                                                    
x.upper ()      mettre en majuscule la chaine x                                                                                         
...
05.01_CM_message_passing                                                                                                    
                                                                                                    
'x' . upper ()      metre la chaine x en majuscule ; envoie un msg : abcd . upper() , renvoie msg ABCD
...
05.04_CM_histogrammes   from matplotlib import pyplot   bibliotheque matplotlib                                                                                             
...
06.01_CM_Factorisation_code_fonction                                                                                                    
...
while (…) :     while [en] = tant que ; instruction composee ; tant que condition=(…) vrai alors boucle continue            
...
input("xx") xx> ?  …    input [en] = donne ; enter une donner qui sera atribuer a une var           
'' xxx''      mettre plusieur ligne en commantaire: 3*'            
...
if y in "…"     si y = a un caractere de " …" alors execute le if   if Y in "ace…" : (rt ligne) print(Y)                                   voir C202    a ; c ; e ….    afiche que les valeure que peut prendre Y
break       break [en] = fin ; si on met dans une condition alors fin du prog   voir C202       
continue        retourne dans la boucle while sans executer ligne endesous de continue  voir C203       
type(4j+3)  complex             
